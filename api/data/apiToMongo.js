...
const City = require("../models/City") // Assuming User model is defined in a separate file
...
async function fetchDataFromAPI(lat, lon) {
    ...
    const apiURL = `http://api.openweathermap.org/data/2.5/air_pollution/history?lat=${lat}&lon=${lon}&start=1711969200&end=1714302000&appid=${apiKeytoUse}`;
        try {
